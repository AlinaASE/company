  ...
  return (
    <div>
      <div className="text-center mb-[40px]">
        <h4 className="text-orange font-semibold mb-2">HOW IT WORKS</h4>
        <h2 className="text-[24px] lg:text-[39px] font-bold w-[80%] lg:w-[60%] mx-auto mb-4">
          Unlock Astonishing Results with Just 3 Simple Steps!
        </h2>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0  px-[6%] space-x-2 mb-[20px]">
        {steps.map((step, index) => (
          <div
            key={index}
            className="min-h-[300px] flex flex-col justify-center items-center border border-orange lg:border-0 lg:border-r lg:border-orange last:lg:border-r-0 text-center p-[25px] rounded-[20px] lg:rounded-none mb-2 lg:mb-0"
          >
